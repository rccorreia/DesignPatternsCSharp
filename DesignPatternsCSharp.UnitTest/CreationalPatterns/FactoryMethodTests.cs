...
namespace DesignPatternsCSharp.UnitTest.CreationalPatterns
{
    ...
    public class FactoryMethodTests
    {
        ...
        public void ShouldCreateHotDogIngredientsWhenHotDogIsInstantiated()
        {
            ...
            for (int i = 0; i < hotDog.Ingredients.Count; i++)
            {
                hotDog.Ingredients[i].Should().BeOfType(hotDogIngredients[i].GetType());
            }
        }
        ...
        public void ShouldCreateBrazilianBauruIngredientsWhenBrazilianBauruIsInstantiated()
        {
            ...
            for (int i = 0; i < brazilianBauru.Ingredients.Count; i++)
            {
                brazilianBauru.Ingredients[i].Should().BeOfType(brazilianBauruIngredients[i].GetType());
            }
        }
